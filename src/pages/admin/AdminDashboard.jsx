...
//                     <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addSaleModal">
//                         Add to Sale
//                     </button>
...
//                                 <div className="modal-footer">
//                                     <button type="button" className="btn btn-secondary" data-bs-dismiss="modal">Close</button>
//                                     <button onClick={handleSaleSubmit} type="button" className="btn btn-primary">Save changes</button>
//                                 </div>
//                             </div>
//                         </div>
//                     </div>
...
import { Link } from 'react-router-dom';
import { toast } from 'react-toastify';
import { createProductApi, createSaleProductApi, deleteProductApi, getAllProductsApi } from '../../apis/Api';
                        ...
                        <div className="modal-dialog">
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    ...
                                    <label htmlFor="">Select category</label>
                                    <select onChange={(e) => setProductCategory(e.target.value)} className='form-control mb-2'>
                                        <option value="Indoor Plants">chairs</option>
                                        <option value="Outdoor Plants">PC</option>
                                        <option value="Birthday Celebration">headphones</option>
                                        <option value="Engagement">laptop</option>
                                    </select>
